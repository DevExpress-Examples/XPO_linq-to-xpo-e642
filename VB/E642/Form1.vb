...
Namespace XpoLinqNorthwindSample
    Partial Public Class Form1
        ...
        Private customers As New XPQuery(Of Customer)(Session.DefaultSession)
        Private orders As New XPQuery(Of Order)(Session.DefaultSession)
        Private employees As New XPQuery(Of Employee)(Session.DefaultSession)
        ...
        Private Sub btnSelectWhere_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSelectWhere.Click
            ...
            Dim myList = From c In customers _
            ...
            For Each cust As Customer In myList
                log.WriteLine(String.Format("{0}" & ControlChars.Tab & "{1}" & ControlChars.Tab & "{2}", cust.ContactName, cust.Country, cust.ContactTitle))
            Next cust
        End Sub
        ...
        Private Sub btnSelectTop_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSelectTop.Click
            ...
            For Each order As Order In myList
                log.WriteLine(String.Format("{0}" & ControlChars.Tab & "{1}" & ControlChars.Tab & "{2}", order.OrderID, order.ShippedDate, order.Customer.CompanyName))
            Next order
        End Sub
        ...
        Private Sub btnJoin_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnJoin.Click
            ...
            For Each item In myList
                log.WriteLine(String.Format("{0}" & ControlChars.Tab & "{1}", item.CompanyName, item.OrderCount))
            Next item
        End Sub
        ...
        Private Sub btnGroup_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGroup.Click
            ...
            For Each item In myList
                log.WriteLine(String.Format("{0}" & ControlChars.Tab & "{1}", item.Title, item.Count))
            Next item
        End Sub
