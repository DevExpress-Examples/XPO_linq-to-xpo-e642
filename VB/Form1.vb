...
Namespace XpoLinqNorthwindSample
    ...
    Public Partial Class Form1
        ...
        Private Sub btnSelectWhere_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Dim myList = From c In customers Where Equals(c.Country, "Germany") AndAlso Equals(c.ContactTitle, "Sales Representative") Order By c.ContactName Select c
        ...
        Private Sub btnAny_Click(ByVal sender As Object, ByVal e As EventArgs)
            log.WriteLine("---------------------------------")
            Dim result As Boolean = customers.Any(Function(c) Equals(c.Country, "Spain"))
            log.WriteLine(String.Format("Is there any customer from Spain? {0}", If(result, "Yes", "No")))
            result = customers.Any(Function(c) Equals(c.Country, "Monaco"))
